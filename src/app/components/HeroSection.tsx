...
const chatMessages: ChatMessage[] = [
  ...
  { id: 2, from: 'ai', text: 'Yes! Our fitness center is open 24/7 on the 2nd floor. Would you like directions?', delay: 2000 },
  { id: 3, from: 'guest', text: 'Can I request late checkout?', delay: 4000 },
  { id: 4, from: 'ai', text: 'Of course — I can help with that. What time would you prefer?', delay: 5400 },
];
...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Hero"
    >
      <div className="absolute top-1/4 right-0 w-[600px] h-[600px] blob-primary -z-10 pointer-events-none opacity-50" aria-hidden="true" />
      <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] blob-secondary -z-10 pointer-events-none opacity-40" aria-hidden="true" />
      <div className="absolute top-0 left-0 right-0 bottom-0 noise-overlay -z-10" aria-hidden="true" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <motion.div 
            ...
            animate="visible"
          >
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2">
            ...
            <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground tracking-tight leading-[1.05]">
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-lg font-medium">
              Ownstay answers guest questions, handles requests, and helps your team deliver better service — 24/7.
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm font-medium text-muted-foreground pt-4 border-t border-border/50">
              {['Available 24/7', 'Built for hospitality', 'Multilingual'].map((item, i) => (
            ...
            <div className="relative animate-float">
              <div className="bg-card/80 backdrop-blur-md rounded-3xl shadow-[0_20px_60px_rgba(31,31,29,0.12)] border border-white/20 overflow-hidden max-w-md mx-auto lg:ml-auto">
                <div className="bg-foreground px-5 py-4 flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-white/60 mt-0.5">AI Receptionist · Grand Pacific Hotel</p>
                  </div>
                      ...
                      >
                        ...
                        <div
                          className={`max-w-[78%] px-4 py-3 rounded-2xl text-sm font-medium leading-relaxed ${
                            msg.from === 'guest' ?'bg-foreground text-white rounded-tr-sm shadow-md' :'bg-white text-foreground border border-black/5 rounded-tl-sm shadow-md'
                          }`}
                        >
                          {msg.text}
                        </div>
                ...
                <div className="px-5 py-4 border-t border-border bg-white">
                  <div className="flex items-center gap-3 bg-secondary/60 border border-black/5 rounded-xl px-4 py-3">
                    <Icon name="ChatBubbleLeftRightIcon" size={18} className="text-muted-foreground flex-shrink-0" />
                    <span className="text-sm text-muted-foreground flex-1">Type a message...</span>
                    <button className="w-8 h-8 rounded-lg bg-primary hover:bg-primary/90 transition-colors shadow-sm flex items-center justify-center flex-shrink-0" aria-label="Send message">
              ...
              <div className="absolute -left-8 top-1/3 bg-white/90 backdrop-blur-lg border border-white/40 rounded-2xl px-5 py-3.5 shadow-[0_10px_30px_rgba(0,0,0,0.08)] hidden lg:flex items-center gap-3 animate-float-delayed">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-medium text-muted-foreground mt-1">Always available</p>
                </div>
              </div>
              ...
              <div className="absolute -right-4 bottom-1/4 bg-white/90 backdrop-blur-lg border border-white/40 rounded-2xl px-5 py-3.5 shadow-[0_10px_30px_rgba(0,0,0,0.08)] hidden lg:flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-medium text-muted-foreground mt-1">100+ languages</p>
                </div>
              </div>
            </div>
          </motion.div>
